...
var SearchableMapLib = {
  ...
  initialize: function(options){
    ...
    if (!SearchableMapLib.map) {
      ...
      var hover_template;
      $.get( "assets/templates/hover.ejs", function( template ) {
  ...
  renderList: function() {
    ...
    if (SearchableMapLib.currentResults.features.length == 0) {
      ...
      var row_content;
      $.get( "assets/templates/table-row.ejs", function( template ) {
  ...
  modalPop: function(data) {
    ...
    var modal_content;
    $.get( "assets/templates/popup.ejs", function( template ) {
  ...
  addIcon: function() {
    SearchableMapLib.centerMark = new L.Marker(SearchableMapLib.currentPinpoint, { icon: (new L.Icon({
            iconUrl: '/assets/img/blue-pushpin.png',
            iconSize: [32, 32],
            iconAnchor: [10, 32]
    }))});
