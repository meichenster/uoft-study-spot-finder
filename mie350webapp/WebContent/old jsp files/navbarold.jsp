<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.jsp">Study Spot Finder</a>
		</div>
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				...
				<li><a 
					href="/mie350webapp/StudentController?action=listStudent">Study Spot
						List (Public)</a></li>
				<li><a href="searchStudent.jsp">Search A Study Spot</a></li>
				<li class="dropdown"><a data-toggle="dropdown"
					href="helpful_links.jsp">Reviews<b class="caret"></b></a>
