				...
				<div class="container d-flex align-items-center justify-content-between">
					...
					<nav id="navbar" class="navbar">
						<ul>
							...
							<li class="dropdown active"><a href="#"><span>Study Spots</span> <i
									...
									<div class="card-body">
										...
										<form action="RegisterController" class="my-login-validation" novalidate="">
											<div class="form-group">
												...
												<input id="name" type="text" class="form-control" name="un" required
													autofocus>
											...
											<div class="form-group">
												...
												<input id="yos" type="text" class="form-control" name="year" required
													data-eye>
												<div class="invalid-feedback">
