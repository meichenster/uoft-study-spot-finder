<%@ page language="java" contentType="text/html; charset=EUC-KR" pageEncoding="EUC-KR"
  import="javax.servlet.http.HttpSession, javax.servlet.http.HttpServletRequest,  javax.servlet.http.HttpServletResponse, javax.servlet.http.HttpServlet, java.util.ArrayList, com.mie.dao.*, com.mie.model.*"
  %>
  <!DOCTYPE html>
  <html lang="en">
          ...
          <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <section id="savedspots" class="contact">
              <div class="container" data-aos="fade-up">
                ...
                <% String username=(String) session.getAttribute("username"); StudySpot studyspots=new StudySpot();
                    ...
                    <c:forEach items="${listofallspots}" var="spots">
                      <div class="col-lg-12">
                        <div class="info-box mb-4">
                          <i class="bx bx-map"></i>
                          <h3>
                            <c:out value="${spots.location}" />
                          </h3>
                          <p>
                            <b>Location ID: </b>
                            <c:out value="${spots.locationID}" /><br>
                            <b>Area:</b>
                            <c:out value="${spots.area}" /><br>
                            <b>Link:</b>
                            <c:out value="${spots.link}" /><br>
                          </p>
                        </div>
                      </div>
                    </c:forEach>
