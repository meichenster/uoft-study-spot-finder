<%@ page language="java" contentType="text/html; charset=EUC-KR" pageEncoding="EUC-KR"
  ...
  <%@ include file="head.jsp" %>
    <% User user=new User(); UserDao dao=new UserDao(); ArrayList <User> listofnames = new ArrayList <User>();
          ...
          <body>
            ...
            <main role="main" class="container-fluid">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group" style="display:none">
                            Search by name
                            <input class="form-control" id="search-name"
                              placeholder="Enter a business or organization name" type="text">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <p>View the list of study spots and save your favorite ones. Select 'List View' to see the full
                          list of study spots and their information. Hover over any green
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="text-center">
                            <button class="btn btn-dark" id="btnViewMode" title="Change view"><i class="fa fa-list"></i>
                              List view</button>
                          </div>
                        </div>
                      </div>
                          ...
                          <form action="SavedSpotsController" class="my-login-validation" novalidate="">
                            <div class="form-group">
                              ...
                              <select name="location" id="location" class="form-control">
                                ...
                                <option value="University of Toronto Students Union">University of Toronto Students
                                  Union</option>
                                ...
                                <option value="Chemical Engineering Common room">Chemical Engineering Common room
                                </option>
                                ...
                                <option value="Electrical and Computer Engineering Common room">Electrical and Computer
                                  Engineering Common room</option>
                                <option value="Mechanical and Industrial Engineering Common room">Mechanical and
                                  Industrial Engineering Common room</option>
                                <option value="TrackOne Engineering Common room">TrackOne Engineering Common room
                                </option>
                                ...
                                <option value="Mechanical and Industrial Engineering Computer Lab">Mechanical and
                                  Industrial Engineering Computer Lab</option>
                                <option value="Mechanical and Industrial Engineering Computer Lab">Mechanical and
                                  Industrial Engineering Computer Lab</option>
                                <option value="Chemical Engineering Computer Lab">Chemical Engineering Computer Lab
                                </option>
                                <option value="Mineral Engineering Computer Lab">Mineral Engineering Computer Lab
                                </option>
                                <option value="Material Science Engineering Computer Lab">Material Science Engineering
                                  Computer Lab</option>
                                <option value="Engineering Science Computer Lab">Engineering Science Computer Lab
                                </option>
                                ...
                                <option value="Victoria College E J Pratt Library">Victoria College E J Pratt Library
                                </option>
                                ...
                                <option value="St. Michael’s College - John M. Kelly Library">St. Michael's College -
                                  John M. Kelly Library</option>
                                <option value="Trinity College Library (John W Graham Library)">Trinity College Library
                                  (John W Graham Library)</option>
                                <option value="Earth Sciences Library (Noranda)">Earth Sciences Library (Noranda)
                                </option>
                              </select>
              ...
              <div class="col-md-6">
                ...
                <p class="float-right">Based on <a href="https://github.com/datamade/searchable-map-template-csv"
                    target="_blank">Searchable Map Template - CSV</a> by <a href="https://derekeder.com/"
                    target="_blank">Derek Eder</a> and <a href="https://datamade.us/" target="_blank">DataMade</a></p>
              </div>
              </div>
